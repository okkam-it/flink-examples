...
public class PhoneNumberStr extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static org.okkam.flink.parquet.avro.PhoneNumberStr.Builder newBuilder() {
    return new org.okkam.flink.parquet.avro.PhoneNumberStr.Builder();
  }
   ...
   * @return A new PhoneNumberStr RecordBuilder
   */
  public static org.okkam.flink.parquet.avro.PhoneNumberStr.Builder newBuilder(org.okkam.flink.parquet.avro.PhoneNumberStr.Builder other) {
    return new org.okkam.flink.parquet.avro.PhoneNumberStr.Builder(other);
  }
   ...
   * @return A new PhoneNumberStr RecordBuilder
   */
  public static org.okkam.flink.parquet.avro.PhoneNumberStr.Builder newBuilder(org.okkam.flink.parquet.avro.PhoneNumberStr other) {
    return new org.okkam.flink.parquet.avro.PhoneNumberStr.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneNumberStr>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.okkam.flink.parquet.avro.PhoneNumberStr.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.okkam.flink.parquet.avro.PhoneNumberStr other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.number)) {
        this.number = data().deepCopy(fields()[0].schema(), other.number);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.okkam.flink.parquet.avro.PhoneNumberStr.Builder setNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.okkam.flink.parquet.avro.PhoneNumberStr.Builder clearNumber() {
      number = null;
