...
public class ElasticsearchHelperITCase {
  ...
  private ArrayList<InetSocketAddress> transports;
  ...
  public void setUpClass() throws IOException {
    ...
    node = NodeBuilder.nodeBuilder()
        .settings(Settings.settingsBuilder().put("path.home", dataDir.getParent())
            .put("http.enabled", false).put("path.data", dataDir.getAbsolutePath()))
